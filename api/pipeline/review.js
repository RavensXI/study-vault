...
module.exports = async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    ...
    let query = supabase
      .from('lessons')
      .select('id, lesson_number, slug, title, status, updated_at, reviewed_at, published_at, hero_image_url, rejection_notes, unit_id, units!inner(name, slug, subject_id, subjects!inner(id, name, slug, school_id))')
