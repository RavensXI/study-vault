"""
Azure TTS narration for Eduqas D&T (design-technology-eduqas).

22 article lessons across 4 units:
  - design-technology-our-world      (6)
  - electronic-mechanical-systems    (5)
  - materials-and-properties         (6)
  - designing-and-making-principles  (5)

Voice: Odd lesson_number -> Ollie / Even -> Ada.
R2 key: design-technology-eduqas/{unit_slug}/narration_lesson-{NN}_{nid}.mp3
"""
...
def main():
    ...
    print("Eduqas D&T — TTS Narration")
    print("=" * 55)
    sb = get_client()
