"""Insert Food Preparation and Nutrition (AQA 8585) lesson content into Supabase.

Each JSON in scripts/_content_food-preparation-and-nutrition-aqa/lessons/ uses flat
...
LESSON_DIR = Path(__file__).parent / "_content_food-preparation-and-nutrition-aqa" / "lessons"
