"""Phase 2 - Subject activation for Food Preparation and Nutrition (AQA 8585), free tier.

Reads scripts/_plan_food-preparation-and-nutrition-aqa.json and creates the subject + 5 units
+ 18 empty lesson shells in Supabase. Updates subjects.settings with
...
plan = json.loads(
    (scripts / "_plan_food-preparation-and-nutrition-aqa.json").read_text(encoding="utf-8")
)
sb = get_client()

SUBJECT_SLUG = plan["subject"]["slug"]  # food-preparation-and-nutrition-aqa
