"""
Generate Azure TTS narration for Psychology AQA (psychology-aqa) free-tier.
32 article-format lessons across 8 units.
...
R2 audio key:
  psychology-aqa/{unit_slug}/narration_lesson-{NN}_{nid}.mp3
"""
import argparse
import io
import os
...
SUBJECT_SLUG = "economics-aqa"
ARTICLE_UNITS = [
    "economic-foundations-and-resource-allocation",
    "how-prices-are-determined",
    "production-costs-and-market-structures",
    "market-failure",
    "national-economy-and-government-objectives",
...
def main():
    ...
    print("Psychology AQA - Narration")
    print("=" * 55)
