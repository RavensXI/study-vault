"""
Generate Azure TTS narration for Religious Studies Edexcel (religious-studies-edexcel).

Narrates all 71 article-format lessons across 15 units:
  Paper 1 (belief/teachings):
  ...
  Paper 3 (philosophy & ethics):
    paper-3-philosophy-ethics-catholic      (5 lessons)
    paper-3-philosophy-ethics-christianity  (5 lessons)
    paper-3-philosophy-ethics-islam         (5 lessons)
  Paper 4 (textual studies):
    paper-4-marks-gospel  (5 lessons)
    paper-4-quran         (5 lessons)
...
R2 audio key pattern:
  religious-studies-edexcel/{unit_slug}/narration_lesson-{NN}_{nid}.mp3

Note on religious-language pronunciation:
  Hebrew, Arabic, and Sanskrit terms are passed as plain English text.
  Azure pronounces them phonetically — acceptable for GCSE audience.
  No SSML lang-switching needed (single-language subject, no fluency exercises).

Usage:
    python scripts/_narrate_religious-studies-edexcel.py
    python scripts/_narrate_religious-studies-edexcel.py --dry-run
    python scripts/_narrate_religious-studies-edexcel.py --unit paper-1-islam
    python scripts/_narrate_religious-studies-edexcel.py --lesson 3
    python scripts/_narrate_religious-studies-edexcel.py --unit paper-2-hinduism --lesson 2
    python scripts/_narrate_religious-studies-edexcel.py --skip-existing
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate TTS narration for Religious Studies Edexcel lessons"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Process only this unit slug (default: all 15 units)"
    )
    parser.add_argument(
    ...
    print("Religious Studies Edexcel — TTS Narration Generator")
    print("=" * 60)
    ...
    print(f"Note: Hebrew/Arabic/Sanskrit terms narrated phonetically as English.")
    if args.dry_run:
        print("Mode: DRY RUN")
