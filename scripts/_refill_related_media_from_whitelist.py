...
WHITELIST = {
    ...
    "computer-science-edexcel": [
        {"category": "Podcasts", "emoji": "🎙️", "title": "Darknet Diaries",
         "url": "https://darknetdiaries.com",
         "description": "True cybercrime and hacking stories — covers malware, social engineering and network breaches at GCSE level."},
        {"category": "Videos & Channels", "emoji": "📺", "title": "Crash Course Computer Science",
         "url": "https://www.youtube.com/@crashcourse",
         "description": "Carrie Anne Philbin's 40-episode GCSE-level CS series — covers every topic on the Edexcel 1CP2 specification."},
        {"category": "Videos & Channels", "emoji": "📺", "title": "Craig'n'Dave GCSE Computer Science",
         "url": "https://www.youtube.com/@craigndave",
         "description": "UK GCSE CS revision channel aligned to the Edexcel specification — lesson-by-lesson videos."},
        {"category": "Documentaries", "emoji": "🎬", "title": "The Imitation Game (2014)",
         "url": "https://www.justwatch.com/uk/movie/the-imitation-game",
         "description": "Alan Turing and the birth of computing — foundational context for every CS lesson."},
        {"category": "Study Tools", "emoji": "🛠️", "title": "Isaac Computer Science",
         "url": "https://isaaccomputerscience.org",
         "description": "DfE-funded free revision platform with interactive questions for every GCSE CS topic."},
        {"category": "Study Tools", "emoji": "🛠️", "title": "BBC Bitesize — Computer Science",
         "url": "https://www.bbc.co.uk/bitesize/subjects/z34k7ty",
         "description": "BBC's GCSE Computer Science hub covering the full specification."},
    ],
    "computer-science-aqa": [
        ...
        {"category": "Videos & Channels", "emoji": "📺", "title": "Crash Course Computer Science",
         "url": "https://www.youtube.com/@crashcourse",
         "description": "Carrie Anne Philbin's 40-episode GCSE-level CS series — covers every AQA 8525 topic."},
        {"category": "Videos & Channels", "emoji": "📺", "title": "Computerphile",
         "url": "https://www.youtube.com/@Computerphile",
         "description": "Brady Haran's expert CS channel — short, deep dives on topics across the AQA specification."},
        {"category": "Documentaries", "emoji": "🎬", "title": "The Imitation Game (2014)",
         "url": "https://www.justwatch.com/uk/movie/the-imitation-game",
         "description": "Alan Turing and the birth of computing — foundational context for every CS lesson."},
        {"category": "Study Tools", "emoji": "🛠️", "title": "Isaac Computer Science",
        ...
        {"category": "Study Tools", "emoji": "🛠️", "title": "BBC Bitesize — Computer Science",
         "url": "https://www.bbc.co.uk/bitesize/subjects/z34k7ty",
         "description": "BBC's GCSE Computer Science hub covering the AQA 8525 specification."},
    ],
