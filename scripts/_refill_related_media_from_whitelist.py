...
WHITELIST = {
    ...
    "classical-civilisation-ocr": [
        {"category": "Podcasts", "emoji": "🎙️", "title": "BBC Sounds",
         "url": "https://www.bbc.co.uk/sounds",
         "description": "BBC Sounds — search for classics and ancient history podcasts (e.g. In Our Time)."},
        {"category": "Videos & Channels", "emoji": "🎬", "title": "Smarthistory (Khan Academy)",
         "url": "https://www.youtube.com/@smarthistoryvideos",
         "description": "Smarthistory — Greek and Roman art and material culture explained."},
        {"category": "Documentaries", "emoji": "🎞️", "title": "BBC iPlayer",
         "url": "https://www.bbc.co.uk/iplayer",
         "description": "BBC iPlayer — search for Mary Beard and ancient Greece/Rome documentaries."},
        {"category": "Study Tools", "emoji": "🧰", "title": "World History Encyclopedia",
         "url": "https://www.worldhistory.org/",
         "description": "Reliable articles on Greek and Roman myth, religion, history and material culture."},
        {"category": "Study Tools", "emoji": "🧰", "title": "Theoi Greek Mythology",
         "url": "https://www.theoi.com/",
         "description": "Detailed reference for the Greek gods, heroes and myths with ancient sources."},
        {"category": "Articles & Reading", "emoji": "📰", "title": "The British Museum",
         "url": "https://www.britishmuseum.org/collection",
         "description": "Search the collection for Greek and Roman objects and prescribed sources."},
    ],
    "economics-aqa": [
        {"category": "Podcasts", "emoji": "🎙️", "title": "BBC Sounds",
         "url": "https://www.bbc.co.uk/sounds",
