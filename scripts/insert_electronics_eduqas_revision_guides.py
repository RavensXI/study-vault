"""
Insert Electronics (Eduqas / WJEC) revision technique guide pages into Supabase.
Subject slug: electronics-eduqas
Subject ID: e4092b51-f928-4bd4-9635-7f3af3f08161
...
SUBJECT_ID = 'e4092b51-f928-4bd4-9635-7f3af3f08161'
...
<p>Evidence-based strategies tailored to GCSE Electronics. Electronics rewards students who can recall component behaviour precisely, derive and apply formulas under time pressure, and design systems from a specification &mdash; these techniques are chosen to match exactly those demands.</p>
</div>
</div>
<div class="guide-hub">
...
<a class="guide-question-card" href="/guide/electronics-eduqas/revision-technique/retrieval-practice">
<span class="guide-question-marks">Active recall</span>
<h3>Retrieval Practice</h3>
<p>Recall all five logic gate truth tables, the V<sub>out</sub> voltage divider formula, and Ohm&rsquo;s law variations from memory. Brain dumps and self-quizzing beat re-reading every time.</p>
</a>
<a class="guide-question-card" href="/guide/electronics-eduqas/revision-technique/spaced-repetition">
<span class="guide-question-marks">Distributed practice</span>
<h3>Spaced Repetition</h3>
<p>Revisit 555 timer formulas, op-amp gain equations, and transistor switching rules at 1, 3, 7, 14, 30-day gaps. Component behaviour sticks through spaced retrieval &mdash; not cramming.</p>
</a>
<a class="guide-question-card" href="/guide/electronics-eduqas/revision-technique/dual-coding">
<span class="guide-question-marks">Visual learning</span>
<h3>Dual Coding</h3>
<p>Combine words and visuals. Annotated I&ndash;V curves for diodes, waveform sketches for astable oscillators, and block-diagram sub-systems stay in memory far longer than written descriptions alone.</p>
</a>
<a class="guide-question-card" href="/guide/electronics-eduqas/revision-technique/elaborative-interrogation">
<span class="guide-question-marks">Deep thinking</span>
<h3>Elaborative Interrogation</h3>
<p>Ask &ldquo;why?&rdquo; and &ldquo;how?&rdquo; to deepen understanding. Why does a NAND gate with tied inputs act as a NOT gate? Why does a longer RC time constant slow the charging curve? Turn memorised facts into understood explanations.</p>
</a>
</div>
</div>
...
<div class="guide-paper-questions">
<a class="guide-question-card" href="/guide/electronics-eduqas/revision-technique/interleaving">
<span class="guide-question-marks">Mixed practice</span>
<h3>Interleaving</h3>
<p>Mix Discovering Electronics and Application of Electronics questions in a single session. Trains the exam skill of telling apart an op-amp gain question from a 555 timer question before choosing a method.</p>
</a>
<a class="guide-question-card" href="/guide/electronics-eduqas/revision-technique/knowledge-organisers">
<span class="guide-question-marks">Structured notes</span>
<h3>Knowledge Organisers</h3>
<p>One-pagers for 555 Timer Modes, Logic Gate Families, and Op-Amp Configurations with formulas and waveforms. Redraw from memory. The base layer of every good revision routine.</p>
</a>
</div>
</div>
...
<div class="guide-paper-questions">
<a class="guide-question-card" href="/guide/electronics-eduqas/revision-technique/timed-practice">
<span class="guide-question-marks">Exam conditions</span>
<h3>Timed Practice</h3>
<p>Simulate the real thing. Time pressure, no notes, handwritten. Focus on the design-from-specification questions &mdash; these require both content knowledge and structured problem-solving under the clock.</p>
</a>
</div>
</div>
...
<button aria-expanded="false" class="collapsible-toggle"><span>Electronics Examples</span><svg class="collapsible-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"/></svg></button>
...
<p>After studying logic gates, close the book and write the complete truth table for all five gates &mdash; AND, OR, NOT, NAND, NOR &mdash; from memory, including the two-input output for every combination of A and B. Check each table against the lesson and rewrite only the ones you got wrong. Next session, cover the tables and add a Boolean expression for each gate.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>After studying voltage dividers and sensing circuits, close your notes and write the V<sub>out</sub> formula, then sketch three sensor circuits from memory &mdash; LDR in a light-sensing divider, thermistor in a temperature-sensing divider, and a potentiometer as an analogue position sensor. Check your dropper-resistor position and the correct output terminal against the worked example before moving on.</p>
</div>
</div></div>
</div>
...
<div class="sidebar-collapsible-content"><a href="/guide/electronics-eduqas/revision-technique/spaced-repetition">Spaced Repetition</a>
<a href="/guide/electronics-eduqas/revision-technique/dual-coding">Dual Coding</a>
<a href="/guide/electronics-eduqas/revision-technique/elaborative-interrogation">Elaborative Interrogation</a>
<a href="/guide/electronics-eduqas/revision-technique/interleaving">Interleaving</a>
<a href="/guide/electronics-eduqas/revision-technique/knowledge-organisers">Knowledge Organisers</a>
<a href="/guide/electronics-eduqas/revision-technique/timed-practice">Timed Practice</a></div>
</div>
</div>
</aside>""",
})
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>The 555 monostable formula T&nbsp;=&nbsp;1.1RC is easy to see once but fades fast. Re-derive it from scratch at the 1-day, 3-day, 7-day, and 14-day gaps &mdash; starting each time from the definition of the RC time constant &tau;&nbsp;=&nbsp;RC and the threshold voltage &frac23; V<sub>cc</sub>. Each re-derivation forces you to reconstruct the reasoning, not just recall a number.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>After studying op-amp gain, log the inverting gain formula (A&nbsp;=&nbsp;&minus;R<sub>f</sub>/R<sub>in</sub>) and the non-inverting gain formula (A&nbsp;=&nbsp;1&nbsp;+&nbsp;R<sub>f</sub>/R<sub>in</sub>) on day one. On day three, cover your notes and apply both to a fresh circuit with R<sub>f</sub>&nbsp;=&nbsp;47&nbsp;k&Omega; and R<sub>in</sub>&nbsp;=&nbsp;10&nbsp;k&Omega;. On day seven, sketch the output waveform for each configuration given a 0.1&nbsp;V peak-to-peak sine input and check for clipping.</p>
</div>
</div></div>
</div>
...
<div class="sidebar-collapsible">
<button class="sidebar-collapsible-toggle" aria-expanded="false"><span>&#128218; Other Techniques</span><svg class="sidebar-collapsible-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg></button>
<div class="sidebar-collapsible-content"><a href="/guide/electronics-eduqas/revision-technique/retrieval-practice">Retrieval Practice</a>
<a href="/guide/electronics-eduqas/revision-technique/dual-coding">Dual Coding</a>
<a href="/guide/electronics-eduqas/revision-technique/elaborative-interrogation">Elaborative Interrogation</a>
<a href="/guide/electronics-eduqas/revision-technique/interleaving">Interleaving</a>
<a href="/guide/electronics-eduqas/revision-technique/knowledge-organisers">Knowledge Organisers</a>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>Write 12 questions drawn equally from op-amp circuits, 555 timer circuits, and logic gate design &mdash; then shuffle them and attempt the set without labelling which topic each belongs to. The key exam skill is recognising whether you need an op-amp gain formula, a 555 timing formula, or a Boolean simplification before you pick up your pen. Blocking the topics in separate sessions means you never train that discrimination.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Mix a Discovering Electronics voltage divider calculation, an Application of Electronics summing amplifier question, and a transistor switching circuit problem within a single 30-minute session. Each requires a different starting formula and a different circuit-analysis approach. After marking, note which type you misidentified &mdash; those misidentifications are exactly what you need to fix before the exam.</p>
</div>
</div></div>
</div>
...
<button class="sidebar-collapsible-toggle" aria-expanded="false"><span>&#128218; Other Techniques</span><svg class="sidebar-collapsible-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg></button>
<div class="sidebar-collapsible-content"><a href="/guide/electronics-eduqas/revision-technique/retrieval-practice">Retrieval Practice</a>
<a href="/guide/electronics-eduqas/revision-technique/spaced-repetition">Spaced Repetition</a>
<a href="/guide/electronics-eduqas/revision-technique/dual-coding">Dual Coding</a>
<a href="/guide/electronics-eduqas/revision-technique/elaborative-interrogation">Elaborative Interrogation</a>
<a href="/guide/electronics-eduqas/revision-technique/knowledge-organisers">Knowledge Organisers</a>
<a href="/guide/electronics-eduqas/revision-technique/timed-practice">Timed Practice</a></div>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>Sketch the I&ndash;V characteristic curve for a silicon diode from memory: flat at near-zero current in reverse bias, then a sharp rise from approximately 0.7&nbsp;V forward voltage. Add a second curve for a zener diode, annotating the forward threshold and the reverse breakdown voltage. Label the three operating regions (forward conduction, reverse blocking, zener regulation) in a different colour &mdash; the visual distinction between forward and reverse behaviour is the key exam concept.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Draw the output waveform of a 555 astable oscillator, annotating the mark time (T<sub>high</sub>&nbsp;=&nbsp;0.693(R<sub>A</sub>&nbsp;+&nbsp;R<sub>B</sub>)C) and space time (T<sub>low</sub>&nbsp;=&nbsp;0.693R<sub>B</sub>C) directly on the waveform. Then sketch the capacitor charging curve beneath it and draw an arrow linking each threshold voltage (1/3 V<sub>cc</sub> and 2/3 V<sub>cc</sub>) to the point on the output where the transistor switches. The visual connection between the RC curve and the output square wave cements how the timer actually works.</p>
</div>
</div></div>
</div>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>When studying NAND-only logic, ask: &ldquo;Why does a NAND gate with both inputs tied together behave as a NOT gate?&rdquo; Work through the truth table entry by entry &mdash; if both inputs are HIGH, output is LOW; if both are LOW, output is HIGH. Then push further: &ldquo;Why is NAND universal?&rdquo; Build the AND from NAND-then-NOT, then OR using De Morgan&rsquo;s theorem. Each &ldquo;why?&rdquo; deepens the schema that exam design questions will test.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>After learning that a D-type flip-flop stores one bit, ask: &ldquo;How does it actually hold a value when the clock goes low?&rdquo; Trace the feedback path through the internal gate structure. Then ask: &ldquo;Why does connecting Q-bar back to D create a toggle flip-flop?&rdquo; Answering these questions from first principles &mdash; rather than just memorising the timing diagram &mdash; means you can handle an unfamiliar counter circuit in the exam without having seen that exact configuration before.</p>
</div>
</div></div>
</div>
...
<li class="guide-step"><span class="guide-step-number">2</span><div class="guide-step-body"><strong>Divide the page into 4&ndash;6 sections</strong> &mdash; typically: Key Vocabulary, Essential Formulas, Core Concepts, Circuit Diagrams / Waveforms, and Common Misconceptions. The structure forces you to categorise.</div></li>
...
<li class="guide-step"><span class="guide-step-number">4</span><div class="guide-step-body"><strong>Use tiny structural visuals</strong> &mdash; a mini waveform sketch, a 2&times;2 truth table, a small circuit block. Dual coding applies: words + visuals beat words alone.</div></li>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>Create one A4 page covering all three 555 timer modes &mdash; monostable, astable, and bistable. Divide it into three columns, one per mode. Each column contains: the trigger condition, the relevant formula (T&nbsp;=&nbsp;1.1RC for monostable; T<sub>high</sub> and T<sub>low</sub> for astable), a tiny sketch of the output waveform, and the pin connections that differ between modes. Redrawing this from memory is one of the highest-value Electronics revision tasks because the modes are easy to confuse under exam pressure.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Build a one-page logic gate reference: six rows (AND, OR, NOT, NAND, NOR, XOR), four columns (symbol, truth table, Boolean expression, plain-English meaning). Add a seventh section at the bottom for NAND-only equivalents of AND, OR, and NOT &mdash; draw the gate constructions in miniature. This single page covers every gate question the exam can ask and can be redrawn from memory in under ten minutes once the habit is established.</p>
</div>
</div></div>
</div>
...
<li>Essential Formulas</li>
<li>Core Concepts</li>
<li>Circuit Diagrams / Waveforms</li>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>Set a 30-minute timer and attempt a past-paper section covering circuit design from a specification &mdash; the question type that asks you to select components, calculate values, and justify your choices. These questions carry the most marks and require the most structured thinking. Doing them under the clock reveals whether you have a reliable method or whether you rely on recognition; recognition alone will not survive an unfamiliar specification.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Target the microcontroller and flowchart section specifically: give yourself 20 minutes to write a complete flowchart program for a given task (for example, a traffic-light sequence using a D-type output register), then mark against the model answer. Pay attention to whether your decision diamonds have the correct yes/no branches and whether your loop returns to the right point &mdash; these structural errors are the most common source of lost marks in this question type and only surface under timed conditions.</p>
</div>
</div></div>
</div>
...
<a href="/guide/electronics-eduqas/revision-technique/elaborative-interrogation">Elaborative Interrogation</a>
<a href="/guide/electronics-eduqas/revision-technique/interleaving">Interleaving</a>
<a href="/guide/electronics-eduqas/revision-technique/knowledge-organisers">Knowledge Organisers</a></div>
</div>
</div>
</aside>""",
})
...
# INSERT ALL PAGES
# ══════════════════════════════════════════════════════════════
print(f"Inserting {len(pages)} guide pages for electronics-eduqas...")

for page in pages:
    result = sb.table('guide_pages').insert({
    ...
    print(f"  Inserted: sort_order={page['sort_order']} slug={page['slug']}")

print("\nDone. Verifying...")
verify = sb.table('guide_pages').select('slug, title, sort_order').eq('subject_id', SUBJECT_ID).eq('guide_type', 'revision-technique').order('sort_order').execute()
print(f"Rows found: {len(verify.data)}")
for row in verify.data:
    print(f"  {row['sort_order']}  {row['slug']:35s}  {row['title']}")
