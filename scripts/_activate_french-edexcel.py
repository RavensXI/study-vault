"""Phase 2 - Subject activation for French (Edexcel 1FR1), free tier.

Reads scripts/_plan_french-edexcel.json and creates the subject + 2 units
...
plan = json.loads(
    (scripts / "_plan_french-edexcel.json").read_text(encoding="utf-8")
)
sb = get_client()

SUBJECT_SLUG = plan["subject"]["slug"]  # french-edexcel
