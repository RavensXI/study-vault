"""Phase 2 - Subject activation for Cambridge Nationals Sport Studies
(OCR J829), free tier.

Reads scripts/_plan_cambridge-nationals-sport-studies.json and
creates the subject + 1 unit + 10 empty lesson shells in Supabase. Updates
...
plan = json.loads(
    (scripts / "_plan_cambridge-nationals-sport-studies.json").read_text(
        encoding="utf-8"
    )
)
sb = get_client()
