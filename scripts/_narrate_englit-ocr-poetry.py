"""
Generate Azure TTS narration for the OCR EngLit poetry clusters (15 lessons each).
Pass --unit to narrate one cluster at a time.
...
R2 audio key:
  english-literature-ocr/{unit_slug}/narration_lesson-{NN}_{nid}.mp3
"""
import argparse
import io
import os
...
ARTICLE_UNITS = ["poetry-conflict", "poetry-love-and-relationships",
                 "poetry-youth-and-age"]
...
def main():
    ...
    print("English Literature OCR - Poetry - Narration")
    print("=" * 55)
