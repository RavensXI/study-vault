# Enterprise & Marketing — Related Media Curation Prompt

You are curating `related_media` for a small batch of Enterprise & Marketing lessons (Cambridge National qualification). Quality bar is high: students should be able to **click any link and immediately reach the content**.
...
2. The lesson JSONs at `scripts/_content_cambridge-nationals-enterprise-and-marketing/lessons/{lesson_slug}.json` for the lessons you're assigned
...
## Strong YouTube channels for Enterprise & Marketing
...
## Documentaries / films that fit Enterprise & Marketing
...
- **No spec codes** ("J837", "R067", "R068", "R069") in titles/descriptions
...
1. Read `scripts/_content_cambridge-nationals-enterprise-and-marketing/lessons/{lesson_slug}.json`
