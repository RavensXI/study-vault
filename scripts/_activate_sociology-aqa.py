"""Phase 2 - Subject activation for Sociology (AQA 8192), free tier.

Reads scripts/_plan_sociology-aqa.json and creates the subject + 2 units
...
plan = json.loads(
    (scripts / "_plan_sociology-aqa.json").read_text(encoding="utf-8")
)
sb = get_client()

SUBJECT_SLUG = plan["subject"]["slug"]  # sociology-aqa
