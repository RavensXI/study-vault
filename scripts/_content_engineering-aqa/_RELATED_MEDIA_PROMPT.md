...
2. The lesson JSONs at `scripts/_content_engineering-aqa/lessons/{lesson_slug}.json` for the lessons you're assigned
...
- **No spec codes** ("8852", "R067", "R068", "R069") in titles/descriptions
...
1. Read `scripts/_content_engineering-aqa/lessons/{lesson_slug}.json`
