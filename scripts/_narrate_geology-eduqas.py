"""
Azure TTS narration for Eduqas Geology (geology-eduqas).

30 article lessons across 5 units:
  - rocks-and-minerals                        (7)
  - structures-and-earth-dynamics             (6)
  - geological-time-and-life                  (5)
  - earth-climate-and-solar-system            (5)
  - hazards-resources-and-investigative-geology (7)

Voice: Odd lesson_number -> Ollie / Even -> Ada.
R2 key: geology-eduqas/{unit_slug}/narration_lesson-{NN}_{nid}.mp3
"""
...
ARTICLE_UNITS = [
    "rocks-and-minerals",
    "structures-and-earth-dynamics",
    "geological-time-and-life",
    "earth-climate-and-solar-system",
    "hazards-resources-and-investigative-geology",
]
...
def main():
    ...
    print("Eduqas Geology — TTS Narration")
    print("=" * 55)
    sb = get_client()
