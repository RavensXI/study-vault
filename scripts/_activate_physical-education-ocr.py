"""Phase 2 - Subject activation for Physical Education (OCR J587), free tier.

Reads scripts/_plan_physical-education-ocr.json and creates the subject + 2 units
...
SUBJECT_SLUG = plan["subject"]["slug"]  # physical-education-ocr
