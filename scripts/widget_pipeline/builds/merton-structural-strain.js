...
(function () {
  ...
  var ADAPTATIONS = [
    ...
    { key: 'innovation', name: 'Innovation', goals: 'Accept', means: 'Reject',
      sig: 'keeping the goal but taking a route society does not approve of' },
  ...
  var CASES = [
    { id: 'inn1', join: 'but', name: 'Priya', answer: 'innovation',
      text: 'Priya wants what everyone around her calls success: money. Her college course was cut, and local jobs pay too little to get her anywhere. She sells fake trainers online.',
      keeps: 'still wants the money',
      route: 'she is taking a route society does not approve of',
      why: 'Merton blamed the gap between the goal and the closed route, not Priya’s character. Anyone in her position feels the same pull.' },
    { id: 'con1', join: 'and', name: 'Devan', answer: 'conformity',
      text: 'Devan wants a trade career, the kind his family respects. Places are scarce and he has been turned down twice. He stays on his course and applies again.',
      keeps: 'still wants the career',
      route: 'he is still on the approved route',
      why: 'Merton counted this as an adaptation too. Devan is blocked, but he is still on the approved route.' },
    { id: 'rit1', join: 'but', name: 'Maryam', answer: 'ritualism',
      text: 'Maryam wanted the manager’s job. After eight years of being passed over, she no longer expects to get it. She still arrives early and follows every rule.',
      keeps: 'has let go of the goal',
      route: 'she still follows the approved routine',
      why: 'Merton argued the routine can carry on long after the ambition behind it has gone.' },
    { id: 'inn2', join: 'but', name: 'Corey', answer: 'innovation',
      text: 'Corey wants what his friends call success: money. He left school without the qualifications employers ask for. He sells fake tickets online.',
      keeps: 'still wants the money',
      route: 'he is taking a route society does not approve of',
      why: 'Merton argued the closed route produced this, not the kind of person Corey is.' },
    { id: 'reb1', join: 'and', name: 'Ella', answer: 'rebellion',
      text: 'Ella wanted a home of her own, but rents are higher than any wage she can earn. She now says private ownership is the wrong goal and campaigns for community housing.',
      keeps: 'has swapped the goal for a new one',
      route: 'she is pushing for a new route too',
      why: 'Merton argued rebellion does more than reject the old goal. It puts a new goal and a new route in its place.' },
    { id: 'ret1', join: 'and', name: 'Nathan', answer: 'retreatism',
      text: 'Nathan chased the qualifications and the job for years. After many rejections he stopped applying, stopped seeing people and dropped out of the routine.',
      keeps: 'has given up the goal',
      route: 'he has given up the route as well',
      why: 'Merton called this the double rejection: the goal is gone, and the route is gone with it.' },
    { id: 'inn3', join: 'but', name: 'Jamie', answer: 'innovation',
      text: 'Jamie needs the grades for the career he wants. His school dropped the subject and he cannot afford a tutor. He pays someone to sit his exam for him.',
      keeps: 'still wants the grades',
      route: 'he is taking a route society does not approve of',
      why: 'Merton argued the goal stayed while the approved route closed. That gap is what pushed Jamie into cheating.' },
    { id: 'con2', join: 'and', name: 'Ola', answer: 'conformity',
      text: 'Ola wants a living from football, which is what success means at his club. The academy released him and trials cost money. He keeps training and saves up for a trial.',
      keeps: 'still wants the career',
      route: 'he is still on the approved route',
      why: 'Merton argued most blocked people stay on the approved route anyway, and that this is what keeps society stable.' },
    { id: 'rit2', join: 'but', name: 'Rehana', answer: 'ritualism',
      text: 'Rehana no longer believes good grades lead to the career she wanted. Her friends got them and got nowhere. She still hands in every homework on time.',
      keeps: 'no longer expects the goal',
      route: 'she still follows the approved routine',
      why: 'Merton argued that following the rules feels safe once the goal looks out of reach.' },
    { id: 'reb2', join: 'and', name: 'Tomas', answer: 'rebellion',
      text: 'Tomas no longer thinks owning things is success, so he has left the career ladder. He grows food on shared land and argues for a new idea of a good life.',
      keeps: 'has swapped the goal for a new one',
      route: 'he is building a new route too',
      why: 'Merton argued rebellion swaps the goal and the route for new ones. That is not the same as dropping out.' }
  ];

  var OPEN_CAP = 'Two questions each time: does the person keep the goal, and do they keep the approved route?';

  var MASTERY_LINE = 'Three in a row — you have it. All five are answers to the same gap, so it is society that sets what is on offer, not the person. Merton’s weakness: he explains theft better than he explains violence, and most blocked people never offend.';
  ...
  var CSS = [
    ...
    /* the class sets display:block, which beats the UA [hidden] rule - restate it
       so the oddBtn.hidden set in renderCase() really hides the row on
       non-innovation cases, where its feedback line would not be true */
    '.svw-mss .mss-odd[hidden]{display:none}',
  ...
  window.SVWidget = {
    ...
    mount: function (root, ctx) {
      ...
      root.appendChild(el('p', 'mss-frame',
        'Merton argued that society sets the same goals for everyone but does not open the approved routes to everyone. Decide which adaptation each person shows.'));
      ...
      function commit() {
        ...
        if (correct && justMastered) {
          ...
          body = '<b>Not quite — you said they are just a bad person.</b> The grid has no row for that, because it sorts people by their situation, not their character. ' +
                 current.name + ' wants what everyone is taught to want, and the approved route has closed. That is <b>' + right.name + '</b>.';
        } else {
        ...
        if (mastered) {
          run.textContent = correct ? 'You have it. Keep going if you want.'
                                   : 'You had it — that one slipped. Try another.';
