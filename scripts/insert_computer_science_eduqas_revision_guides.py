"""
Insert Computer Science (Eduqas/WJEC) revision technique guide pages into Supabase.
Subject slug: computer-science-eduqas
Subject ID: d68547a6-98a4-4846-a057-42a5f14f6a38
...
CS_SUBJECT_ID = 'd68547a6-98a4-4846-a057-42a5f14f6a38'
SLUG = 'computer-science-eduqas'
...
<p>Evidence-based strategies tailored to GCSE Computer Science. This subject rewards students who can convert fluently between binary, denary and hexadecimal under time pressure, recall the 7 OSI layers in the correct order, name the relevant UK legislation with confidence, trace through algorithms step by step, and apply logical operators without hesitation &mdash; these techniques are chosen to match exactly those demands.</p>
</div>
</div>
<div class="guide-hub">
...
<a class="guide-question-card" href="/guide/computer-science-eduqas/revision-technique/retrieval-practice">
<span class="guide-question-marks">Active recall</span>
<h3>Retrieval Practice</h3>
<p>Close the book and write all 7 OSI layers in order, brain-dump the 5 UK laws with one offence each, or reproduce a truth table from memory. Self-testing beats re-reading every time.</p>
</a>
<a class="guide-question-card" href="/guide/computer-science-eduqas/revision-technique/spaced-repetition">
<span class="guide-question-marks">Distributed practice</span>
<h3>Spaced Repetition</h3>
<p>Binary&ndash;hex&ndash;denary conversions and two&rsquo;s complement arithmetic need spacing &mdash; drill them at 1, 3, 7, 14-day gaps. Formulas and layer names stick through spaced retrieval, not cramming.</p>
</a>
<a class="guide-question-card" href="/guide/computer-science-eduqas/revision-technique/dual-coding">
<span class="guide-question-marks">Visual learning</span>
<h3>Dual Coding</h3>
<p>Draw a truth table for <code>A AND NOT B</code>, then sketch the logic gate diagram alongside &mdash; both together beats prose. Combine words and visuals for FDE cycles, OSI stacks, and network topologies.</p>
</a>
<a class="guide-question-card" href="/guide/computer-science-eduqas/revision-technique/elaborative-interrogation">
<span class="guide-question-marks">Deep thinking</span>
<h3>Elaborative Interrogation</h3>
<p>Ask &ldquo;why is binary search O(log n) but linear search O(n)?&rdquo; and derive the answer from how each algorithm actually works. Turning memorised facts into understood explanations earns the marks.</p>
</a>
</div>
</div>
...
<div class="guide-paper-questions">
<a class="guide-question-card" href="/guide/computer-science-eduqas/revision-technique/interleaving">
<span class="guide-question-marks">Mixed practice</span>
<h3>Interleaving</h3>
<p>Mix hardware, networks, and data-representation questions in one session &mdash; the exam does not tell you which topic each question is on. Trains you to identify what&rsquo;s being asked before you answer it.</p>
</a>
<a class="guide-question-card" href="/guide/computer-science-eduqas/revision-technique/knowledge-organisers">
<span class="guide-question-marks">Structured notes</span>
<h3>Knowledge Organisers</h3>
<p>One A4 with all 7 OSI layers &mdash; function, hardware example, protocol example, common mistake. Redraw from memory. The base layer of every good revision routine.</p>
</a>
</div>
</div>
...
<div class="guide-paper-questions">
<a class="guide-question-card" href="/guide/computer-science-eduqas/revision-technique/timed-practice">
<span class="guide-question-marks">Exam conditions</span>
<h3>Timed Practice</h3>
<p>30 minutes of data-representation calculations and binary arithmetic under exam conditions, handwritten and timed. Builds the pace and composure the written paper demands.</p>
</a>
</div>
</div>
...
<button aria-expanded="false" class="collapsible-toggle"><span>Computer Science Examples</span><svg class="collapsible-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"/></svg></button>
...
<p>After studying the OSI model, close your notes and write all 7 layers from Physical up to Application &mdash; name, one-sentence function, and one protocol or hardware example for each. Check what you missed and rewrite only the gaps the next day. Most students muddle up the order of Session, Presentation, and Application first; those three layers are the ones to drill hardest.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>After covering UK computer legislation, brain-dump the five Acts from memory: Computer Misuse Act 1990, Data Protection Act 2018 / UK GDPR, Copyright Designs and Patents Act 1988, Regulation of Investigatory Powers Act 2000, Freedom of Information Act 2000 &mdash; with one offence or protection per law. Check against the lesson, rewrite any you missed, and test again at the end of the week. This is a guaranteed 4&ndash;6 mark block if you can recall all five with precision.</p>
</div>
</div></div>
</div>
...
<div class="sidebar-collapsible-content"><a href="/guide/computer-science-eduqas/revision-technique/spaced-repetition">Spaced Repetition</a>
<a href="/guide/computer-science-eduqas/revision-technique/dual-coding">Dual Coding</a>
<a href="/guide/computer-science-eduqas/revision-technique/elaborative-interrogation">Elaborative Interrogation</a>
<a href="/guide/computer-science-eduqas/revision-technique/interleaving">Interleaving</a>
<a href="/guide/computer-science-eduqas/revision-technique/knowledge-organisers">Knowledge Organisers</a>
<a href="/guide/computer-science-eduqas/revision-technique/timed-practice">Timed Practice</a></div>
</div>
</div>
</aside>""",
})
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>Binary, hexadecimal, and denary conversions are procedural skills that decay fast without practice. After first learning 8-bit two&rsquo;s complement on Monday, do 5 conversion problems on Tuesday, a different set on Thursday, another set the following Monday, and again two weeks later. By the fourth session you should be converting without counting on fingers &mdash; the procedure has become automatic. Only spacing achieves this; a single cramming session does not.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Cycle through the six Computer Science units over six weeks &mdash; Hardware, Networks, Data Representation, Logic and OS, Algorithms and Programming, Society and Ethics &mdash; one unit per week. In week 7, return to Hardware before it fades. Each return session should be a retrieval attempt (brain dump the FDE cycle steps or CPU performance factors), not re-reading. After three full cycles most students can recall key definitions and procedures without prompting.</p>
</div>
</div></div>
</div>
...
<div class="sidebar-collapsible">
<button class="sidebar-collapsible-toggle" aria-expanded="false"><span>&#128218; Other Techniques</span><svg class="sidebar-collapsible-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg></button>
<div class="sidebar-collapsible-content"><a href="/guide/computer-science-eduqas/revision-technique/retrieval-practice">Retrieval Practice</a>
<a href="/guide/computer-science-eduqas/revision-technique/dual-coding">Dual Coding</a>
<a href="/guide/computer-science-eduqas/revision-technique/elaborative-interrogation">Elaborative Interrogation</a>
<a href="/guide/computer-science-eduqas/revision-technique/interleaving">Interleaving</a>
<a href="/guide/computer-science-eduqas/revision-technique/knowledge-organisers">Knowledge Organisers</a>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>In one 45-minute session, mix questions from three units: a binary-to-hex conversion from Data Representation, a question on packet switching from Networks, and a CPU fetch-decode-execute question from Hardware. The exam paper jumps between topics without warning &mdash; training yourself to shift context mid-session is exactly the skill it tests. After marking, note which topic caused the most confusion and make that the first block of your next session.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Mix algorithm tracing, truth table completion, and legislation recall in one practice set. These three task types feel very different but all appear on the written paper. Students who only ever drill one at a time often freeze when the exam jumps from a bubble sort trace to a Boolean algebra simplification. Interleaving them in practice removes the freeze &mdash; you know what you&rsquo;re looking at before you start writing.</p>
</div>
</div></div>
</div>
...
<h2>Common Pitfalls</h2>
<ul class="guide-mistakes">
<li><strong>Random, not related.</strong> Interleaving Computer Science with History is just subject-switching. Interleave WITHIN a subject &mdash; related topics that students confuse.</li>
...
<button class="sidebar-collapsible-toggle" aria-expanded="false"><span>&#128218; Other Techniques</span><svg class="sidebar-collapsible-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg></button>
<div class="sidebar-collapsible-content"><a href="/guide/computer-science-eduqas/revision-technique/retrieval-practice">Retrieval Practice</a>
<a href="/guide/computer-science-eduqas/revision-technique/spaced-repetition">Spaced Repetition</a>
<a href="/guide/computer-science-eduqas/revision-technique/dual-coding">Dual Coding</a>
<a href="/guide/computer-science-eduqas/revision-technique/elaborative-interrogation">Elaborative Interrogation</a>
<a href="/guide/computer-science-eduqas/revision-technique/knowledge-organisers">Knowledge Organisers</a>
<a href="/guide/computer-science-eduqas/revision-technique/timed-practice">Timed Practice</a></div>
...
<h2>Step-by-Step Method</h2>
<ol class="guide-steps">
<li class="guide-step"><span class="guide-step-number">1</span><div class="guide-step-body"><strong>Pick a topic with relationships</strong> &mdash; processes, layers, hierarchies, comparisons. Dual coding shines when there&rsquo;s structure to capture.</div></li>
<li class="guide-step"><span class="guide-step-number">2</span><div class="guide-step-body"><strong>Choose the right visual format</strong> &mdash; flowchart for the FDE cycle or algorithms, layered stack diagram for OSI, truth table + gate diagram for Boolean logic, comparison table for storage types.</div></li>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>Draw a truth table for <code>A AND NOT B</code> with all four input combinations, then sketch the logic gate circuit alongside it &mdash; an AND gate with a NOT gate on the B input. Having both representations on the same page means you can see that when A=1 and B=0 the output is 1, and also see exactly which gates produce that result. Redraw both from memory a week later &mdash; most students find the gate diagram harder to recall than the table, which tells you where to focus.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Create a 7-row stack diagram for the OSI model: each layer labelled with its name, one-word function (e.g. Physical &rarr; Transmission, Transport &rarr; Reliability), and one protocol or hardware example. Draw arrows showing data flowing down on the sender side and up on the receiver side. This single visual encodes more than a page of bullet points. Remove the labels and redraw the whole stack from memory &mdash; the visual structure helps you rebuild the order even when individual names slip.</p>
</div>
</div></div>
</div>
...
<h4>Formats</h4>
<ol class="guide-quick-ref-steps">
<li>Flowchart (FDE, algorithms)</li>
<li>Layer stack (OSI model)</li>
<li>Truth table + gate diagram</li>
<li>Comparison table (storage types)</li>
<li>Annotated network diagram</li>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>After learning that binary search is O(log n) and linear search is O(n), ask: &ldquo;why is binary search faster?&rdquo; The answer leads you to the halving property &mdash; each comparison eliminates half the remaining data. Then ask: &ldquo;why can&rsquo;t binary search work on an unsorted list?&rdquo; Because the algorithm assumes that if the target is smaller than the midpoint, it must be in the left half &mdash; which is only true if the data is ordered. These two &ldquo;why?&rdquo; questions give you more exam marks than memorising the definitions alone.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>After studying packet switching, ask: &ldquo;why does the internet use packets rather than sending a whole file as a single continuous stream?&rdquo; The answer involves fault tolerance, efficient bandwidth sharing, and re-routing around failures. Then ask: &ldquo;why does each packet need a header?&rdquo; Because routers need to know the destination, sequence number, and checksum without receiving the whole file first. Chaining these questions builds the kind of understanding that answers 6-mark &ldquo;explain and justify&rdquo; questions without needing to memorise a scripted response.</p>
</div>
</div></div>
</div>
...
<div class="guide-section">
<h2>When to Use This</h2>
<p>Any time you&rsquo;re covering conceptual material &mdash; not just listing facts. Particularly powerful for Computer Science because so much of the mark scheme rewards explanation over recall: &ldquo;state and explain&rdquo;, &ldquo;describe how&rdquo;, &ldquo;justify your choice&rdquo;. Build it into every lesson revisit, not as a separate session.</p>
</div>
</main>
...
<li>Why this design and not another?</li>
...
<li class="guide-step"><span class="guide-step-number">4</span><div class="guide-step-body"><strong>Use tiny structural visuals</strong> &mdash; a mini OSI stack, a small truth table, a compact flowchart. Dual coding applies: words + visuals beat words alone.</div></li>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>Make one A4 organiser for the OSI model with four columns: layer name, function in one phrase, hardware or software example, and one common exam mistake. Seven rows, one per layer. Include a tiny numbered stack diagram in the corner. This single page encodes everything examiners ask about OSI. Redraw it blank &mdash; filling in all four columns from memory &mdash; every few days in the run-up to the exam. By the third redraw the layer order and functions should come without hesitation.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Create a UK Legislation organiser with five rows, one per Act: Act name and year, what it covers, one example offence or protection, and the maximum penalty. This is a guaranteed mark-earner if you can reproduce it accurately under pressure &mdash; students who know all five laws with a real example each consistently outscore those who can only name two or three. Redraw the whole table from memory once a week from January onwards.</p>
</div>
</div></div>
</div>
...
<li>Key Facts / Definitions</li>
<li>Core Concepts</li>
<li>Worked Examples / Procedures</li>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>Set a 30-minute timer and attempt a mixed set of data-representation questions under exam conditions &mdash; binary-to-denary conversion, 8-bit two&rsquo;s complement of a negative number, hexadecimal addition, and a file-size calculation. No notes, handwritten. This is the section most students underestimate for speed: the arithmetic looks simple but under time pressure small errors compound. Practising this under the clock trains both accuracy and pace before the real paper.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Take a full algorithm tracing question from a past paper &mdash; trace a bubble sort through five iterations, showing the array state after each pass &mdash; and give yourself exactly the number of minutes the marks allow. Mark your answer against the expected output. If you ran out of time, that tells you the tracing is too slow; if you finished early and got it wrong, the issue is accuracy not pace. Both are fixable, but only timed practice reveals which one you need to work on.</p>
</div>
</div></div>
</div>
...
<a href="/guide/computer-science-eduqas/revision-technique/elaborative-interrogation">Elaborative Interrogation</a>
<a href="/guide/computer-science-eduqas/revision-technique/interleaving">Interleaving</a>
<a href="/guide/computer-science-eduqas/revision-technique/knowledge-organisers">Knowledge Organisers</a></div>
</div>
</div>
</aside>""",
})
...
# INSERT
# ══════════════════════════════════════════════════════════════
print(f"Inserting {len(pages)} guide pages for {SLUG}...")

for page in pages:
    result = sb.table('guide_pages').upsert({
        "subject_id": page["subject_id"],
        "guide_type": page["guide_type"],
        "slug": page["slug"],
        "title": page["title"],
...
verify = sb.table('guide_pages').select('id,slug,sort_order').eq('subject_id', CS_SUBJECT_ID).eq('guide_type', 'revision-technique').order('sort_order').execute()
print(f"Rows in Supabase: {len(verify.data)}")
for row in verify.data:
    print(f"  sort_order={row['sort_order']}  slug={row['slug']}")
