"""Azure TTS narration for Engineering
(engineering-aqa).
...
R2 key: engineering-aqa/{unit_slug}/narration_lesson-{NN}_{nid}.mp3
"""
...
ARTICLE_UNITS = [
    ...
    "engineering-systems",
    "testing-drawing-and-the-engineering-industry",
]
...
def main():
    ...
    print("Engineering - TTS Narration")
    print("=" * 60)
    sb = get_client()
