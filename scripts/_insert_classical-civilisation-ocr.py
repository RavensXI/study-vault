"""Insert Classical Civilisation (OCR J199) lesson content into Supabase.

Each JSON in scripts/_content_classical-civilisation-ocr/lessons/ uses flat
...
LESSON_DIR = Path(__file__).parent / "_content_classical-civilisation-ocr" / "lessons"
