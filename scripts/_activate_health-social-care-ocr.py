"""Phase 2 - Subject activation for Health and Social Care (OCR J835), free tier.

Reads scripts/_plan_health-social-care-ocr.json and creates the subject + 2 units
...
plan = json.loads(
    (scripts / "_plan_health-social-care-ocr.json").read_text(encoding="utf-8")
)
sb = get_client()

SUBJECT_SLUG = plan["subject"]["slug"]  # health-social-care-ocr
