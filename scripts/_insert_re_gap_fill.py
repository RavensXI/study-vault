...
Each JSON in scripts/_content_religious-education-gap-fill/lessons/ uses flat
...
LESSON_DIR = Path(__file__).parent / "_content_religious-education-gap-fill" / "lessons"
