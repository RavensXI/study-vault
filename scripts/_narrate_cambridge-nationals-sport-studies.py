"""Azure TTS narration for Cambridge Nationals Sport Studies
...
R2 key: cambridge-nationals-sport-studies/{unit_slug}/narration_lesson-{NN}_{nid}.mp3
"""
...
def main():
    ...
    print("Cambridge Nationals Sport Studies - TTS Narration")
    print("=" * 60)
    sb = get_client()
