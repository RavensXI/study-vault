"""Azure TTS narration for Cambridge Nationals Enterprise & Marketing
...
R2 key: cambridge-nationals-enterprise-and-marketing/{unit_slug}/narration_lesson-{NN}_{nid}.mp3
"""
...
def main():
    ...
    print("Cambridge Nationals Enterprise & Marketing - TTS Narration")
    print("=" * 60)
    sb = get_client()
