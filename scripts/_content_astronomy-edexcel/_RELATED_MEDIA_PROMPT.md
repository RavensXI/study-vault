...
2. The lesson JSONs at `scripts/_content_astronomy-edexcel/lessons/{lesson_slug}.json` for the lessons you're assigned
...
- **No spec codes** ("1AS0", "R067", "R068", "R069") in titles/descriptions
...
1. Read `scripts/_content_astronomy-edexcel/lessons/{lesson_slug}.json`
