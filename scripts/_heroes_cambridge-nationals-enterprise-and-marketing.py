...
12 lessons across 1 unit:
  - enterprise-and-marketing-concepts (L1-L12)

Workflow per lesson:
  1. Load hero_keywords from scripts/_content_cambridge-nationals-enterprise-and-marketing/lessons/{slug}.json
...
SUBJECT_SLUG = "cambridge-nationals-enterprise-and-marketing"
...
def main():
    ...
    LESSONS = [("enterprise-and-marketing-concepts", n) for n in range(1, 13)]
    ...
    for unit_slug, lesson_number in LESSONS:
        ...
        alt_text = f"{lesson_title} — Enterprise and Marketing"
