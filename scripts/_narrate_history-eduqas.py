"""Azure TTS narration for History (history-eduqas).

167 article lessons across 16 units (4 British depth, 4 non-British depth,
4 Period Studies, 4 Thematic Studies).

Voice: Odd lesson_number -> Ollie / Even -> Ada.
R2 key: history-eduqas/{unit_slug}/narration_lesson-{NN}_{nid}.mp3
"""
...
ARTICLE_UNITS = [
    ...
    "conflict-upheaval-england-1337-1381",
    "elizabethan-age-1558-1603",
    "empire-reform-war-1890-1918",
    "austerity-affluence-discontent-1951-1979",
    # Non-British depth studies
    "crusades-1095-1149",
    "voyages-discovery-conquest-americas-1492-1522",
    "germany-transition-1919-1939",
    "usa-nation-contrasts-1910-1929",
    # Period studies
    "development-usa-1929-2000",
    "development-germany-1919-1991",
    "development-ussr-1924-1991",
    "development-uk-1919-1990",
    # Thematic studies
    "crime-punishment-britain-c500-present",
    "health-medicine-britain-c500-present",
    "warfare-britain-c500-present",
    "entertainment-leisure-britain-c500-present",
]
...
def main():
    ...
    print("History (Eduqas) - TTS Narration")
    print("=" * 60)
    sb = get_client()
    ...
    missing = [s for s in ARTICLE_UNITS if s not in umap]
    if missing:
        print(f"WARNING: units not found in Supabase: {missing}")
    ...
    for slug, n, clips, chars, el, err in results:
        ...
        print(f"  {slug:<46} L{n:02d}   {status}")
