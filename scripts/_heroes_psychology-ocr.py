# -*- coding: utf-8 -*-
"""Phase 4 hero images for OCR Psychology (psychology-ocr) free-tier.
31 lessons across 7 units. Lesson JSONs live in the API-build run dir
...
SUBJECT_SLUG = "psychology-ocr"
SUBJECT_NAME = "Psychology (OCR)"
...
def main():
    ...
    for unit_slug, lesson_number, filename in pairs:
        ...
        alt_text = f"{lesson_title} — {unit_display} for OCR GCSE Psychology"
