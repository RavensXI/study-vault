"""Phase 2 - Subject activation for Physical Education (AQA 8582), free tier.

Reads scripts/_plan_physical-education-aqa.json and creates the subject + 2 units
...
plan = json.loads(
    (scripts / "_plan_physical-education-aqa.json").read_text(encoding="utf-8")
)
sb = get_client()

SUBJECT_SLUG = plan["subject"]["slug"]  # physical-education-aqa
