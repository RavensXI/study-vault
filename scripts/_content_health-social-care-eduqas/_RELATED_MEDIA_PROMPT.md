...
2. The lesson JSONs at `scripts/_content_health-social-care-eduqas/lessons/{lesson_slug}.json` for the lessons you're assigned
...
- **No spec codes** ("5249QA", "R067", "R068", "R069") in titles/descriptions
...
1. Read `scripts/_content_health-social-care-eduqas/lessons/{lesson_slug}.json`
