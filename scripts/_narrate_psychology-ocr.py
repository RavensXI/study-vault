"""
Generate Azure TTS narration for Psychology OCR (psychology-ocr) free-tier.
31 article-format lessons across 7 units.
...
R2 audio key:
  psychology-ocr/{unit_slug}/narration_lesson-{NN}_{nid}.mp3
"""
import argparse
import io
import os
...
def main():
    ...
    print("Psychology OCR - Narration")
    print("=" * 55)
