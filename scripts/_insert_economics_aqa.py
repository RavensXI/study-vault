"""Insert Economics (AQA 8136) lesson content into Supabase.

Each JSON in scripts/_content_economics-aqa/lessons/ uses flat
...
LESSON_DIR = Path(__file__).parent / "_content_economics-aqa" / "lessons"
