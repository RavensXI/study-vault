"""
Insert Design and Technology (Eduqas/WJEC) revision technique guide pages into Supabase.
Subject slug: design-technology-eduqas
Subject ID: 32fd71a2-9800-4988-a869-59e2802e0783
school_id: NULL (free tier)
guide_type: revision-technique
status: live
8 rows: 1 hub index + 7 individual technique pages

Neutral Eduqas/WJEC phrasing throughout — no board names in prose.
Written paper only (50% of total mark); NEA not addressed.
Q6 is the 12-mark extended-response on one material area.
"""
...
DT_SUBJECT_ID = '32fd71a2-9800-4988-a869-59e2802e0783'
SLUG = 'design-technology-eduqas'
...
<p>Evidence-based strategies tailored to GCSE Design and Technology. The written paper rewards students who can recall material properties and manufacturing processes precisely, apply mechanical calculations under time pressure, name and describe specific designers and their products, and construct a detailed extended response on a single material area for the 12-mark Q6 &mdash; these techniques are chosen to match exactly those demands.</p>
</div>
</div>
<div class="guide-hub">
...
<a class="guide-question-card" href="/guide/design-technology-eduqas/revision-technique/retrieval-practice">
<span class="guide-question-marks">Active recall</span>
<h3>Retrieval Practice</h3>
<p>Close the book and brain-dump the 6 Rs, the 5 spec-named designers, and the properties of each material group. Brain dumps and self-quizzing beat re-reading every time.</p>
</a>
<a class="guide-question-card" href="/guide/design-technology-eduqas/revision-technique/spaced-repetition">
<span class="guide-question-marks">Distributed practice</span>
<h3>Spaced Repetition</h3>
<p>Material properties and mechanical values need spacing to stick &mdash; drill tensile strength, melt temperatures, and gear-ratio calculations at 1, 3, 7, 14, 30-day gaps rather than cramming the night before.</p>
</a>
<a class="guide-question-card" href="/guide/design-technology-eduqas/revision-technique/dual-coding">
<span class="guide-question-marks">Visual learning</span>
<h3>Dual Coding</h3>
<p>Sketch lever classes, gear trains, and the IPO model with labels. Annotated diagrams of I-beam cross-sections and woven/knitted fabric structures stick far better than prose descriptions.</p>
</a>
<a class="guide-question-card" href="/guide/design-technology-eduqas/revision-technique/elaborative-interrogation">
<span class="guide-question-marks">Deep thinking</span>
<h3>Elaborative Interrogation</h3>
<p>Ask &ldquo;why?&rdquo; and &ldquo;how?&rdquo; to deepen understanding. Why does an I-beam resist bending better than a solid bar of equal mass? Why is HDPE used for milk bottles rather than PET? Turn memorised facts into understood explanations.</p>
</a>
</div>
</div>
...
<div class="guide-paper-questions">
<a class="guide-question-card" href="/guide/design-technology-eduqas/revision-technique/interleaving">
<span class="guide-question-marks">Mixed practice</span>
<h3>Interleaving</h3>
<p>Mix materials, mechanical calculations, and named-designer questions in one session. The key exam discrimination skill is knowing which material area Q6 is testing &mdash; interleaving trains exactly that.</p>
</a>
<a class="guide-question-card" href="/guide/design-technology-eduqas/revision-technique/knowledge-organisers">
<span class="guide-question-marks">Structured notes</span>
<h3>Knowledge Organisers</h3>
<p>One A4 page per material group &mdash; papers, timbers, metals, polymers, fibres, and fabric construction &mdash; covering sources, properties, and manufacturing processes. Redraw from memory. The base layer of every good revision routine.</p>
</a>
</div>
</div>
...
<div class="guide-paper-questions">
<a class="guide-question-card" href="/guide/design-technology-eduqas/revision-technique/timed-practice">
<span class="guide-question-marks">Exam conditions</span>
<h3>Timed Practice</h3>
<p>Simulate the real thing &mdash; including the 30-minute timed run at the 12-mark Q6 material extended response. Time pressure, no notes, handwritten. Builds the exam skill, not just the content.</p>
</a>
</div>
</div>
...
<button aria-expanded="false" class="collapsible-toggle"><span>Design and Technology Examples</span><svg class="collapsible-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"/></svg></button>
...
<p>After studying the Sustainability unit, close the book and write down all 6 Rs from memory &mdash; Rethink, Refuse, Reduce, Reuse, Recycle, Repair &mdash; with one specific product example for each. Then check your answers: which Rs did you confuse or forget? Rewrite only the missed ones tomorrow and test yourself again.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Brain-dump the 5 specification-named designers &mdash; Airbus, Apple, Dyson, Starck, Williamson &mdash; with one signature product and one design decision for each, from memory. Check your notes, mark gaps in red, and retest 24 hours later. Precision here directly protects marks in the designers and companies questions.</p>
</div>
</div></div>
</div>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>Material properties &mdash; such as mild steel tensile strength (~400 MPa), aluminium density (2.7 g/cm&sup3;), and HDPE melt temperature (~130&deg;C) &mdash; need spacing to stick. Learn the metals lesson today, do a quick recall of all three values tomorrow, again on day 3, day 7, and day 14. By the time the exam arrives, these figures are automatic, freeing mental load for the extended Q6 response.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>The 6 Rs of sustainability are easily confused under pressure. After first covering the topic, schedule five spaced retrieval sessions across three weeks &mdash; each time writing down all six from memory with one product example each. If you blank on &ldquo;Rethink&rdquo; at day 7, reset that card to day 1 and repeat. The reset is the learning, not a failure.</p>
</div>
</div></div>
</div>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>Sketch the three lever classes side by side &mdash; Class 1 (effort&ndash;fulcrum&ndash;load, like scissors), Class 2 (fulcrum&ndash;load&ndash;effort, like a wheelbarrow), Class 3 (fulcrum&ndash;effort&ndash;load, like tweezers) &mdash; with the effort, load, and fulcrum clearly labelled on each. Cover and redraw from memory the next day. Diagrams beat prose descriptions of mechanical advantage every time in a revision session.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Draw a comparison table for the six material groups &mdash; papers/boards, timbers, metals, polymers, natural textiles, and synthetic textiles &mdash; with columns for source, one property advantage, one property disadvantage, and one common product. Leave the cells blank, photocopy it, and fill it in from memory weekly. This is the Q6 extended-response knowledge encoded in retrieval-ready form.</p>
</div>
</div></div>
</div>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>You know the fact: an I-beam resists bending better than a solid rectangular bar of the same mass. Now ask &ldquo;why?&rdquo; &mdash; because the material is concentrated at the top and bottom flanges where bending stress is highest, while the web in the middle carries shear. Then ask &ldquo;why does that matter for design?&rdquo; &mdash; it allows lighter structures in construction, reducing material cost and carbon footprint. This chain of reasoning is exactly what the 12-mark Q6 rewards.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>You know that HDPE is used for milk bottles. Ask &ldquo;why HDPE and not PET?&rdquo; &mdash; HDPE is opaque (protects milk from UV), has a higher melt temperature (can be sterilised), and is cheaper to blow-mould in volume. Then ask &ldquo;why does opacity matter for milk?&rdquo; &mdash; UV light degrades riboflavin, shortening shelf life. A one-word material fact becomes a four-step explanation that earns analysis marks.</p>
</div>
</div></div>
</div>
...
<div class="guide-section">
<h2>When to Use This</h2>
<p>Any time you&rsquo;re covering conceptual material &mdash; not just listing facts. Particularly powerful with material science (properties and why they arise from structure), mechanical systems (why a gear ratio works), and sustainability (why one manufacturing choice is preferable to another). Build it into every lesson revisit, not as a separate session.</p>
</div>
</main>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>Mix materials, mechanical calculations, and named-designer questions in one 45-minute session: a gear-ratio calculation, a question on the properties of softwood versus hardwood, then a describe-and-evaluate question on Dyson&rsquo;s design approach. The key exam discrimination skill is identifying which topic area Q6 is targeting &mdash; interleaving builds exactly that recognition before you see the paper.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Create a mixed set of short-answer cards covering smart materials (thermochromic, piezoelectric), electronic components (input&ndash;process&ndash;output examples), and sustainability (6 Rs, lifecycle assessment) and shuffle them randomly. Attempt 12 in 20 minutes. Students who block &ldquo;smart materials&rdquo; for a whole session find they can answer those questions but freeze when a mixed exam question requires switching between topic areas.</p>
</div>
</div></div>
</div>
...
<h2>Common Pitfalls</h2>
<ul class="guide-mistakes">
<li><strong>Random, not related.</strong> Interleaving Design and Technology with Maths is just subject-switching. Interleave WITHIN a subject &mdash; related topics that students confuse.</li>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>Create one A4 knowledge organiser per material area &mdash; one for papers and boards, one for timbers, one for metals, one for polymers, one for fibres, one for fabric construction. Each page covers: source (where the material comes from), key properties (one advantage, one disadvantage), common products, and the main manufacturing process used with it. Six pages covers the entire material knowledge the Q6 extended-response could draw on &mdash; redraw one from memory each day in the final two weeks.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Build a single organiser for the five specification-named designers: Airbus (A380, lightweight composite fuselage), Apple (iPhone, user-centred design language), Dyson (DC01 vacuum, cyclone technology), Starck (Juicy Salif, postmodern aesthetic), Williamson (sustainable jewellery, ethical sourcing). Columns: designer name, signature product, key design decision, and link to a D&amp;T principle (sustainability, aesthetics, function). Cover and reproduce weekly until it takes under three minutes.</p>
</div>
</div></div>
</div>
...
<div class="guide-template">
<div class="guide-template-label">Example 1</div>
<p>Set a 30-minute timer and attempt the 12-mark Q6 extended-response question under full exam conditions &mdash; no notes, handwritten. Before starting, read the question carefully to identify which material area it targets: papers, timbers, metals, polymers, fibres, or fabric construction. Students who have practised this cold switching from recognition to extended writing are far less likely to run out of time or drift into the wrong material group.</p>
</div>
<div class="guide-template">
<div class="guide-template-label">Example 2</div>
<p>Work through a past-paper section on electronic and mechanical systems timed at one mark per minute &mdash; give yourself 20 minutes for a 20-mark section. When the timer stops, note exactly where you were. Students who repeatedly run out of time on mechanical calculations are signalling a recall problem, not just a speed problem: the calculation itself should take under two minutes if the method is secure.</p>
</div>
</div></div>
</div>
...
for page in pages:
    ...
    existing = sb.table('guide_pages').select('id').eq('subject_id', DT_SUBJECT_ID).eq('guide_type', 'revision-technique').eq('slug', slug).execute()
    if existing.data:
        ...
        print(f"  UPDATED  [{page['sort_order']}] {slug}")
    else:
        ...
        print(f"  INSERTED [{page['sort_order']}] {slug}")

# ──────────────────────────────────────────────────────────────
# VERIFY
# ──────────────────────────────────────────────────────────────
result = sb.table('guide_pages').select('slug,title,sort_order').eq('subject_id', DT_SUBJECT_ID).eq('guide_type', 'revision-technique').order('sort_order').execute()
print(f"\nVerification — {len(result.data)} rows in guide_pages for {SLUG}:")
for row in result.data:
    print(f"  [{row['sort_order']}] {row['slug']:40s} {row['title']}")
