"""Phase 2 - Subject activation for Cambridge Nationals Engineering
(AQA 8852), free tier.

Reads scripts/_plan_engineering-aqa.json and
creates the subject + 4 units + 22 empty lesson shells in Supabase. Updates
...
plan = json.loads(
    (scripts / "_plan_engineering-aqa.json").read_text(
        encoding="utf-8"
    )
)
sb = get_client()
