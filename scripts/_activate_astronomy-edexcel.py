"""Phase 2 - Subject activation for Cambridge Nationals Astronomy
(Edexcel 1AS0), free tier.

Reads scripts/_plan_astronomy-edexcel.json and
creates the subject + 2 units + 26 empty lesson shells in Supabase. Updates
...
plan = json.loads(
    (scripts / "_plan_astronomy-edexcel.json").read_text(
        encoding="utf-8"
    )
)
sb = get_client()
