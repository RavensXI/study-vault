"""Phase 2 - Subject activation for Cambridge Nationals History
(Eduqas C100QS), free tier.

Reads scripts/_plan_history-eduqas.json and
creates the subject + 16 units + 167 empty lesson shells in Supabase. Updates
...
plan = json.loads(
    (scripts / "_plan_history-eduqas.json").read_text(
        encoding="utf-8"
    )
)
sb = get_client()
