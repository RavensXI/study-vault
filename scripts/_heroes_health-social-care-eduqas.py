...
Workflow per lesson:
  1. Load hero_keywords from scripts/_content_health-social-care-eduqas/lessons/{slug}.json
...
def main():
    ...
    LESSONS = ([("growth-development-lifespan", n) for n in range(1, 8)] + [("self-concept-measuring-health", n) for n in range(1, 7)])
    ...
    for unit_slug, lesson_number in LESSONS:
        ...
        alt_text = f"{lesson_title} — Health and Social Care"
