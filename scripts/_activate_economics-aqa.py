"""Phase 2 - Subject activation for Economics (AQA 8136), free tier.

Reads scripts/_plan_economics-aqa.json and creates the subject + 6 units
...
plan = json.loads(
    (scripts / "_plan_economics-aqa.json").read_text(encoding="utf-8")
)
sb = get_client()

SUBJECT_SLUG = plan["subject"]["slug"]  # economics-aqa
