"""Phase 2 - Subject activation for Classical Civilisation (OCR J199), free tier.

Reads scripts/_plan_classical-civilisation-ocr.json and creates the subject + 4 units
+ 21 empty lesson shells in Supabase. Updates subjects.settings with
...
plan = json.loads(
    (scripts / "_plan_classical-civilisation-ocr.json").read_text(encoding="utf-8")
)
sb = get_client()

SUBJECT_SLUG = plan["subject"]["slug"]  # classical-civilisation-ocr
