...
Workflow per lesson:
  1. Load hero_keywords from scripts/_content_astronomy-edexcel/lessons/{slug}.json
...
def main():
    ...
    LESSONS = (
        [("naked-eye-astronomy", n) for n in range(1, 13)] +
        [("telescopic-astronomy", n) for n in range(1, 15)]
    )
    ...
    for unit_slug, lesson_number in LESSONS:
        ...
        alt_text = f"{lesson_title} — Astronomy"
