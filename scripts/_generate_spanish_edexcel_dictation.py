...
def main():
    ...
    parser.add_argument('--subject', default='french-edexcel')
    ...
    lang_map = {"spanish": "es", "french": "fr", "german": "de", "french-edexcel": "fr", "french-aqa": "fr", "spanish-aqa": "es", "spanish-edexcel": "es", "german-aqa": "de", "german-edexcel": "de"}
    ...
    for slug in subjects:
        ...
        subj = sb.table('subjects').select('id').eq('slug', slug).is_('school_id', 'null').execute().data
        if not subj:
            ...
            for lesson in lessons:
                ...
                for tier_name in ['bronze', 'silver', 'gold']:
                    ...
                    for i, problem in enumerate(problems):
                        ...
                        r2_key = f"{slug}/dictation/{unit['slug']}_L{lesson['lesson_number']:02d}_{tier_name}_{i}.mp3"
