"""Phase 2 - Subject activation for Cambridge Nationals Health and Social Care
(Eduqas/WJEC 5249QA), free tier.

Reads scripts/_plan_health-social-care-eduqas.json and
creates the subject + 2 units + 13 empty lesson shells in Supabase. Updates
...
plan = json.loads(
    (scripts / "_plan_health-social-care-eduqas.json").read_text(
        encoding="utf-8"
    )
)
sb = get_client()
