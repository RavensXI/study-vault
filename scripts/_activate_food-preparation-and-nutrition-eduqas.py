"""Phase 2 - Subject activation for Food Preparation and Nutrition (Eduqas C560QS), free tier.

Reads scripts/_plan_food-preparation-and-nutrition-eduqas.json and creates the subject + 2 units
...
plan = json.loads(
    (scripts / "_plan_food-preparation-and-nutrition-eduqas.json").read_text(encoding="utf-8")
)
sb = get_client()

SUBJECT_SLUG = plan["subject"]["slug"]  # food-preparation-and-nutrition-eduqas
