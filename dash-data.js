...
var SUBSLUG = {
  ...
  econ: { aqa: 'economics-aqa' }, stats: { aqa: 'statistics-aqa', edexcel: 'statistics-edexcel' }, media: { aqa: 'media-studies-aqa', eduqas: 'media-studies-eduqas' },
  film: { eduqas: 'film-studies-eduqas' }, drama: { aqa: 'drama-aqa' },
  music: { aqa: 'music-aqa', edexcel: 'music-edexcel', ocr: 'music-ocr', eduqas: 'music-eduqas' },
...
function svUnitForCohort(settings, uslug) {
  ...
  return !mine || (Array.isArray(y) ? y.indexOf(mine) >= 0 : y === mine);
}
