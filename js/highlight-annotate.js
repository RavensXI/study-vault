...
(function () {
  ...
  function injectStyles() {
    ...
    s.textContent =
      ...
      // Highlight Mode — subtly dim the page background so the article body
      // visually "lifts" off the page. Just a body-bg shift; sidebar/header
      // untouched so the student can still glance at them.
      'body{transition:background-color .3s ease}' +
      'body.sv-hl-mode{background:#ede8df}' +
      'body.dark-mode.sv-hl-mode{background:#161513}' +
