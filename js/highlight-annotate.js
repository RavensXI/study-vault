...
(function () {
  ...
  function injectStyles() {
    ...
    s.textContent =
      ...
      // card sideways without shifting text. Vertical padding adds breathing
      // room inside the card; no negative vertical margin, so the card
      // doesn't overlap the audio player above or the exam tip below.
      'body.sv-hl-mode #study-notes{background:#fff;border-radius:12px;padding:20px;margin:0 -20px;box-shadow:0 12px 40px -8px rgba(45,42,38,.25), 0 2px 8px rgba(45,42,38,.08);transition:background-color .3s ease, box-shadow .3s ease}' +
      ...
      '@media (max-width:640px){.sv-hl-fab-stack{bottom:16px}}' +
