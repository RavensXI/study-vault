...
A 30-second film of the cell cycle and mitosis for GCSE Biology: one body cell grows, copies its chromosomes and divides into two genetically identical cells, drawn entirely by JavaScript on a canvas, with music and sound effects synthesised in JavaScript.
It ships as one self-contained HTML file and as a rendered MP4 for YouTube Shorts.
The look and editing follow `docs/reference-analysis.md`; the biology follows `docs/art-bible.md` section 10.
