// STUB
// Placeholder for shot 08 'pull-apart' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'pull-apart',
  draw(ctx, t, info) {
    ...
    L.text(ctx, info.shot.title || 'pull-apart', 540, 1420, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'pull-apart', 540, 1480, { size: 30, align: 'center', color: P.inkSoft });
