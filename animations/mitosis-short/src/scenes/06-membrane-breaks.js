// STUB
// Placeholder for shot 06 'membrane-breaks' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'membrane-breaks',
  draw(ctx, t, info) {
    ...
    const seed = L.hash('membrane-breaks');
    L.paper(ctx);
    ...
    L.text(ctx, info.shot.title || 'membrane-breaks', 540, 1420, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'membrane-breaks', 540, 1480, { size: 30, align: 'center', color: P.inkSoft });
