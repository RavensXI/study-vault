// STUB
// Placeholder for shot 11 'loop' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'loop',
  draw(ctx, t, info) {
    ...
    L.text(ctx, info.shot.title || 'loop', 540, 1420, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'loop', 540, 1480, { size: 30, align: 'center', color: P.inkSoft });
