// STUB
// Placeholder for shot 10 'two-cells' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'two-cells',
  draw(ctx, t, info) {
    ...
    L.text(ctx, info.shot.title || 'two-cells', 540, 1420, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'two-cells', 540, 1480, { size: 30, align: 'center', color: P.inkSoft });
