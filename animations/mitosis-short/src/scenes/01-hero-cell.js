// STUB
// Placeholder for shot 01 'hero-cell' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'hero-cell',
  draw(ctx, t, info) {
    ...
    L.text(ctx, info.shot.title || 'hero-cell', 540, 1420, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'hero-cell', 540, 1480, { size: 30, align: 'center', color: P.inkSoft });
