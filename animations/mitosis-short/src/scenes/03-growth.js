// STUB
// Placeholder for shot 03 'growth' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'growth',
  draw(ctx, t, info) {
    ...
    L.text(ctx, info.shot.title || 'growth', 540, 1420, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'growth', 540, 1480, { size: 30, align: 'center', color: P.inkSoft });
