...
|---------|-----------|---------|-------|
| History | AQA | 60 | 4 |
| Business Studies | Pearson Edexcel | 30 | 2 |
| Geography | AQA | 40 | 2 |
| Sport Science | OCR | 10 | 1 |
| Drama | OCR | 12 | 2 |
| Food Preparation & Nutrition | AQA | 10 | 1 |
...
- [ ] Biology (Separate) — AQA
- [ ] Chemistry (Separate) — AQA
- [ ] Physics (Separate) — AQA
...
## Removed (coursework-only, no written exam)
- ~~Fine Art — AQA~~
- ~~Textiles — AQA~~
- ~~Photography — AQA~~
