...
| Music Elements | `unit-gcse-music-1` | `#059669` (emerald) |
| Music Forms & Devices | `unit-gcse-music-2` | `#7c3aed` (purple) |
| Music for Ensemble | `unit-gcse-music-3` | `#0891b2` (cyan) |
| Popular Music | `unit-gcse-music-4` | `#ea580c` (orange) |
| Film Music | `unit-gcse-music-5` | `#dc2626` (red) |
| Toto Africa | `unit-gcse-music-6` | `#2563eb` (blue) |
| Eng Lit Macbeth | `unit-english-literature-1` | `#991b1b` (dark red) |
| Eng Lit A Christmas Carol | `unit-english-literature-2` | `#1d4ed8` (blue) |
